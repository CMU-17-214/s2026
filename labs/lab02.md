...
<u>Fork</u> and clone this repository: <https://github.com/CMU-17-214/s26-lab02>. (You can just click the Fork button above `<> Code` on GitHub to fork the repository.) Note that you cannot make changes to the original respository; you need to fork first to be able to commit and push your changes.
